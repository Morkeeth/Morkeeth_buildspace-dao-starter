...
const tokenModule = sdk.getTokenModule(
  "<0x06BabCa1dcD3A65Dd0b59C89Dcf5ca13dcA7A80d"
);

const voteModule = sdk.getVoteModule(
  "0x16Cd22D5A3f57424Fabf3a614f168A14dB6923Ce",
);
...
const App = () => {
  ...
  if (error && error.name === "UnsupportedChainIdError") {
    return (
      <div className="unsupported-network">
        <h2>Let's connect to Rinkeby</h2>
        <p>
          We're still testing for Buildspace, let's save some gass and switch to Rinkeby
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free Frozen beer Carlos Matos</h1>
      <button
        disabled={isClaiming}
        onClick={() => {
          setIsClaiming(true);
